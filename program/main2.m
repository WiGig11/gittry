...
for i = 1:length(fnames)
    ...
    xlswrite('G:\硕士期间\光纤传感\数据\gittry\reliefF算法\test1.xlsx',temp,'sheet1',[char(64+i),num2str(1)]);
    xlswrite('G:\硕士期间\光纤传感\数据\gittry\pythonProject1\test1.xlsx',temp,'sheet1',[char(64+i),num2str(1)]);
end
% ,[char(65+i),num2str(1)]
% sizef = size(feature);
