function [step_freq_accurate,peak_pos,peak1,peak1_index] = get_peak_pos_1(vec,matrix,num_peak1,delta_peak_time1,startpos,GAP)
...
for i = 2:num_peak1                               %双保险
    ...
    if suspect_peak1_index(i)>length(vec)
        peak1_index(i) = 5000;
    else
